...
\begin{tabularx}{0.96\textwidth}{@{}>{\raggedright\arraybackslash}p{0.42\textwidth}>{\raggedleft\arraybackslash}p{0.22\textwidth}>{\raggedright\arraybackslash}X@{}}
\toprule
Quantity & Value & Note \\
\midrule
...
Median angular rate & \mbox{29.276 arcsec hr$^{-1}$} & Derived from augmented geometry \\
