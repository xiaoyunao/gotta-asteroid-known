...
Figure~\ref{fig:lightcurve_examples} shows folded light curves for the 24 objects retained in the updated validation sample. The panel titles list the initial period and the adopted single- or double-peaked period used for the displayed phase folding. The black curves show the Fourier models used for the morphology check. Table~\ref{tab:period_results} summarizes the final period-analysis validation table, including the GOTTA and 60 cm Schmidt measurement counts, the effective number of retained photometric points, the adopted period, period uncertainty, period model, preferred photometric measurement type, search-quality flag, and final-quality flag. These results demonstrate that, although the GOTTA Prototype data alone are generally too sparse for period determination, the recovered known-object catalog can be combined with auxiliary observations to validate the asteroid period-analysis pipeline.

\begin{figure}[!htbp]
\centering
\includegraphics[width=0.98\textwidth,height=0.39\textheight,keepaspectratio]{figures_v6/lightcurve_reliable.png}
\vspace{0.5em}
\includegraphics[width=0.98\textwidth,height=0.39\textheight,keepaspectratio]{figures_v6/lightcurve_questionable.png}
\caption{Phase-folded light curves for the 24 objects in the updated combined GOTTA Prototype and 60 cm Schmidt validation sample. The two mosaics show the objects assigned reliable and questionable final quality flags, respectively. Colored points denote retained measurements from different data subsets, gray points mark rejected or lower-weighted measurements, and black curves show the adopted Fourier models. Each panel gives the object identifier and the candidate period information used in the current period analysis.}
