\begin{table*}[!htbp]
\centering
\caption{Period-analysis validation sample from the combined GOTTA Prototype and Xinglong 60/90 cm Schmidt Telescope data.}
...
\item[$e$] Quality flag assigned from the agreement among the period-search methods: reliable (Rel.), good (Good), or possible (Poss.).
